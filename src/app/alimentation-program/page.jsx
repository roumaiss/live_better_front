  ...
  return (
    <>
      <div>
        ...
        {/* Paragraph Section */}
        <div className=" mx-[2rem] lg:mx-[5rem] mt-10">
        ...
        {/* Recipe Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-16 mx-[2rem] lg:mx-[5rem] my-10">
          {recipes.map((recipe) => (
            <div
              key={recipe.id}

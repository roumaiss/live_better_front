...
const coaches = [
  ...
  },
  {
    ...
    specialties: ["Weight Loss", "Athletic Performance", "Functional Training"],
    certifications: [
...
export default async function RecipeDetail({ params }) {
  ...
  return (
    <>
      ...
      <div className=" max-w-screen-xl gap-6 flex justify-center items-center flex-col mx-[1rem] lg:mx-[5rem] my-[1rem] lg:my-[2rem]">
        <div className="flex flex-col justify-center items-center gap-4 border px-2 py-16 w-full lg:w-2/3">
          <img
            src={currentCoache.image}
            className="w-96 h-96 object-cover mb-4 rounded-lg shadow-lg"
          />

          <div className="flex flex-col items-center  bg-blue-100 w-full lg:w-2/3 p-4 rounded-2xl">
            ...
            <div className="flex flex-col lg:flex-row justify-between w-full ">
              <ul className="list-disc list-inside flex flex-col gap-2 ">
                ...
                {currentCoache.specialties.map((speciality, index) => (
              ...
              <ul className="list-disc list-inside flex flex-col gap-2  ">
                ...
                {currentCoache.certifications.map((certification, index) => (
                  <li key={index} className="text-gray-700 mb-2">
                    {certification}
                  </li>
                ))}

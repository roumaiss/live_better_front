...
export default function Home() {
    ...
    return (
        <>
            ...
            {/* Hero Section */}
            <div className="flex flex-col lg:flex-row items-center justify-between  mx-[2rem] lg:mx-[5rem] bg-blue-50 border-b border-blue-500 my-10 lg:my-0">
                {/* Text on the left */}
                <div className="w-full lg:w-1/2 mb-10 lg:mb-20 px-5">
            ...
            <div className="  py-10 mx-[2rem] lg:mx-[5rem] ">
